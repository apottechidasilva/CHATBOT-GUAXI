...
<body>
    ...
    <nav class="sticky top-0 z-50 p-6 glass-card border-none rounded-none border-b border-cyan-500/10 shadow-lg">
        <div class="max-w-7xl mx-auto flex justify-between items-center w-full">
            ...
            <div class="hidden md:flex gap-8 text-sm items-center">
                ...
                <a onclick="navigate('atendimento')" class="nav-link hidden" id="nav-atendimento">Meu Atendimento</a>
                <a onclick="navigate('metricas')" class="nav-link text-emerald-400 hover:text-emerald-300 hidden" id="nav-metricas">Métricas</a>
    ...
    <script>
        ...
        const defaultProjects = [
            ...
            { id: 3, cat: 'Logística', title: 'Plataforma de Gestão de Armazém', image: 'https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&w=1200', desc: 'Integração de sensores e leitores de código para controlar stocks em tempo real e automatizar fluxos de picking.', results: 'Redução de 28% no tempo de processamento e melhoria de 18% na acuracidade de inventário.' },
            { id: 5, cat: 'Manutenção', title: 'Diagnóstico Predictivo Inteligente', image: 'https://images.unsplash.com/photo-1517430816045-df4b7de3c87d?auto=format&fit=crop&w=1200', desc: 'Sistema de monitorização de vibração e temperatura que antecipa falhas de motores, bombas e redutores.', results: 'Manutenção planejada 6 semanas antes da falha e diminuição de 65% em paradas não programadas.' }
        ];
